...
void SSD1306::sendCommand(uint8_t command) {
  ...
  i2c_write_timeout_us(this->i2c, this->DevAddr, mess, 2, false, TIMEOUT);
}
...
void SSD1306::sendData(uint8_t *buffer, size_t buff_size) {
  ...
  i2c_write_timeout_us(this->i2c, this->DevAddr, mess, buff_size + 1, false, TIMEOUT);
}
 ...
 */
uint8_t SSD1306::getWidth() { return this->width; }